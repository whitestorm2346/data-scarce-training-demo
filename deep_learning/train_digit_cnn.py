...
from deep_learning.digit_cnn_model import DigitCNN
...
def run_deep_learning_digit(args, console):
    set_seed(args.seed)
    ...
    val_acc, val_report, val_cm = evaluate_model(
        ...
        prefix=f"digit_dl_val_{args.epochs}epochs"
    )
    ...
    test_acc, test_report, test_cm = evaluate_model(
        ...
        class_names=class_names,
        output_dir="outputs/reports",
        prefix=f"digit_dl_test_{args.epochs}epochs"
    )
